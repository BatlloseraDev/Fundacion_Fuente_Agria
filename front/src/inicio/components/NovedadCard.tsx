...
export const NovedadCard = ({ imagenUrl, etiqueta, fecha, titulo, descripcion, enlace }: NovedadItem) => {
    return (
        <div className="card h-100 border shadow-sm rounded-4 overflow-hidden transition-all">
            ...
            <div className="card-body d-flex flex-column p-4">
                ...
                <a href={enlace} className="btn btn-outline-primary w-100 mt-auto rounded-3 fw-semibold">
                    Ver novedad
                </a>
